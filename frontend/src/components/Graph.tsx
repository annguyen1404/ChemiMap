...
const Graph = (props: GraphProps) => {
  ...
  useEffect(() => {
    ...
    const simulation = d3
      ...
      .force("charge", d3.forceManyBody().strength(-30)) // Adjust repulsion strength
      .force("center", d3.forceCenter(width / 2, height / 2)) // Center nodes
      .force("collide", d3.forceCollide().radius((d: any) => d.weight*sizeFactor/2 + 10).strength(1)); // Prevent overlap
